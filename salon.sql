...
INSERT INTO public.appointments VALUES (1, '9', 4, 1);
INSERT INTO public.appointments VALUES (15, '11:00', 4, 2);
INSERT INTO public.appointments VALUES (16, '8:30', 4, 3);
INSERT INTO public.appointments VALUES (23, '9:15', 20, 3);
...
INSERT INTO public.customers VALUES (4, '111-1111', 'mario');
INSERT INTO public.customers VALUES (20, '000-0000', 'jane');
...
INSERT INTO public.services VALUES (2, 'hairDress');
...
--
-- Name: appointments fk_appoint_customer; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.appointments
    ADD CONSTRAINT fk_appoint_customer FOREIGN KEY (customer_id) REFERENCES public.customers(customer_id);


--
-- Name: appointments fk_appoint_service; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.appointments
    ADD CONSTRAINT fk_appoint_service FOREIGN KEY (service_id) REFERENCES public.services(service_id);
